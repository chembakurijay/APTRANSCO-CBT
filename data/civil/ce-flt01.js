...
export const questions = [
  ...
  },
  {
    ...
    "formula": "",
    "explanation": "CORRECT: A true, R false\n\nWHY CORRECT:\nThe centre has zero shear ordinate; R is false. This uniquely selects “A true, R false”. See per-option mechanisms under TRAP ANALYSIS.\n\nCALCULATION:\nN/A — conceptual / judgement / matching / theory-assumptions (no arithmetic key).\n\nTRAP ANALYSIS (every wrong option):\nA) Both true; R explains A: Selecting “Both true; R explains A” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “A true, R false”, not “Both true; R explains A” (different quantity, basis, or operating regime).\nB) Both true; R does not explain A: Selecting “Both true; R does not explain A” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “A true, R false”, not “Both true; R does not explain A” (different quantity, basis, or operating regime).\nC) A false, R true: Selecting “A false, R true” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “A true, R false”, not “A false, R true” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Mohr centre is always on the σ-axis at ((σx+σy)/2 , 0) — its shear coordinate is 0.\n• Radius R=√[((σx−σy)/2)² + τxy²]; principals = centre±R.\n• Changing τxy changes R (and principals), not the vertical position of the centre.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Principal angle: tan 2θp = 2τxy/(σx−σy).\n• Max shear stress = R; planes 90° (Mohr) from principal planes.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
  ...
  },
  {
    ...
    "questionType": "Numerical",
    "formula": "",
    "explanation": "CORRECT: 1.2 MPa at neutral axis\n\nWHY CORRECT:\nAverage = 0.8 MPa; rectangular maximum = 1.5×average = 1.2 MPa at NA.\n\nCALCULATION:\naverage = 0.8 MPa; rectangular maximum = 1.5×average = 1.2 MPa at NA.\nFinal keyed result: 1.2 MPa at neutral axis.\n\nTRAP ANALYSIS (every wrong option):\nB) 0.8 MPa at extreme fibre: Selecting “0.8 MPa at extreme fibre” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “1.2 MPa at neutral axis”, not “0.8 MPa at extreme fibre” (different quantity, basis, or operating regime).\nC) 0.8 MPa uniformly: Selecting “0.8 MPa uniformly” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “1.2 MPa at neutral axis”, not “0.8 MPa uniformly” (different quantity, basis, or operating regime).\nD) 1.2 MPa at top fibre: Selecting “1.2 MPa at top fibre” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “1.2 MPa at neutral axis”, not “1.2 MPa at top fibre” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• τ_avg = V/(b d). For 100×200 mm and V=16 kN → τ_avg=16000/(100·200)=0.8 MPa.\n• Rectangle elastic: τ_max = (3/2) τ_avg = 1.2 MPa, located at the neutral axis.\n• At extreme fibres of a rectangle, elastic beam shear stress is 0 — never put τ_max there.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Circular section: τ_max=(4/3)τ_avg on NA.\n• I-section: almost all shear in web ≈ V/(d·tw) estimate.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
  ...
  },
  {
    ...
    "questionType": "Numerical",
    "formula": "",
    "explanation": "CORRECT: \\(3wL/16\\)\n\nWHY CORRECT:\nCompatibility leaves half the UDL deflection to be cancelled by the prop, giving \\(3wL/16\\).\n\nCALCULATION:\ncompatibility leaves half the UDL deflection to be cancelled by the prop, giving \\(3wL/16\\).\nFinal keyed result: \\(3wL/16\\).\n\nTRAP ANALYSIS (every wrong option):\nA) \\(3wL/8\\): Selecting “\\(3wL/8\\)” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “\\(3wL/16\\)”, not “\\(3wL/8\\)” (different quantity, basis, or operating regime).\nB) \\(wL/4\\): Selecting “\\(wL/4\\)” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “\\(3wL/16\\)”, not “\\(wL/4\\)” (different quantity, basis, or operating regime).\nC) \\(5wL/8\\): Selecting “\\(5wL/8\\)” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “\\(3wL/16\\)”, not “\\(5wL/8\\)” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• No settlement propped cantilever + full UDL: Rp=3wL/8 upward.\n• If prop settlement Δ = ½ of unpropped free-end deflection, compatibility halves the cancelled deflection ⇒ Rp=3wL/16.\n• Always write δ_UDL − δ_Rp = Δ_prop with consistent signs.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Δ=0 recovers Rp=3wL/8.\n• Point load at tip/midspan uses different Rp formulas — do not reuse UDL result.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-GATE→Transco"
  },
  {
    ...
    "formula": "",
    "explanation": "CORRECT: A concentrated couple acts at C\n\nWHY CORRECT:\nA concentrated moment causes a BMD discontinuity; a point force jumps shear.\n\nCALCULATION:\nFinal keyed result: A concentrated couple acts at C.\n\nTRAP ANALYSIS (every wrong option):\nB) A point load acts at C: Selecting “A point load acts at C” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “A concentrated couple acts at C”, not “A point load acts at C” (different quantity, basis, or operating regime).\nC) A UDL starts at C: Selecting “A UDL starts at C” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “A concentrated couple acts at C”, not “A UDL starts at C” (different quantity, basis, or operating regime).\nD) The flexural rigidity changes at C: Selecting “The flexural rigidity changes at C” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “A concentrated couple acts at C”, not “The flexural rigidity changes at C” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Concentrated couple ⇒ vertical jump in BMD; SFD stays continuous if no point force there.\n• Point force ⇒ jump in SFD (=force); BMD has a kink (slope change), not a jump.\n• EI change alters curvature M/EI only — it does not create equilibrium jumps on SFD/BMD.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• UDL start/stop ⇒ change in slope of SFD (dV/dx=−w), smooth change in BMD curvature.\n• Relations: dM/dx=V and dV/dx=−w diagnose diagram signatures.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Diagram-Core/Family",
    "diagramSource": "core",
  ...
  },
  {
    ...
    "formula": "",
    "explanation": "CORRECT: a-4, b-2, c-3, d-1\n\nWHY CORRECT:\n(a) 3wl²/8; (b) wl²/6; (c) wl²/8; (d) w(2l)²/8 = wl²/2.\n\nCALCULATION:\n(a) 3wl²/8; (b) wl²/6; (c) wl²/8; (d) w(2l)²/8 = wl²/2.\nFinal keyed result: a-4, b-2, c-3, d-1.\n\nTRAP ANALYSIS (every wrong option):\nB) a-4, b-1, c-3, d-2: Selecting “a-4, b-1, c-3, d-2” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “a-4, b-2, c-3, d-1”, not “a-4, b-1, c-3, d-2” (different quantity, basis, or operating regime).\nC) a-3, b-1, c-2, d-4: Selecting “a-3, b-1, c-2, d-4” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “a-4, b-2, c-3, d-1”, not “a-3, b-1, c-2, d-4” (different quantity, basis, or operating regime).\nD) a-1, b-2, c-3, d-4: Selecting “a-1, b-2, c-3, d-4” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “a-4, b-2, c-3, d-1”, not “a-1, b-2, c-3, d-4” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “a-4, b-2, c-3, d-1”.\n• For matching+beam BM models: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same matching+beam BM models with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for matching+beam BM models (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC",
    "matchingMatrix": {
  ...
  },
  {
    ...
    "explanation": "CORRECT: The column’s self-weight is included as a distributed axial compressive load in the ideal Euler model\n\nWHY CORRECT:\nEnergy equivalence for sudden loading gives σ_sudden ≈ 2 σ_gradual.\n\nCALCULATION:\nenergy equivalence for sudden loading gives σ_sudden ≈ 2 σ_gradual.\nFinal keyed result: The column’s self-weight is included as a distributed axial compressive load in the ideal Euler model.\n\nTRAP ANALYSIS (every wrong option):\nA) The column is initially straight and the axial load is concentric: Selecting “The column is initially straight and the axial load is concentric” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “The column’s self-weight is included as a distributed axial compressive load in the ideal Euler model”, not “The column is initially straight and the axial load is concentric” (different quantity, basis, or operating regime).\nB) The material remains linearly elastic up to the buckling load: Selecting “The material remains linearly elastic up to the buckling load” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “The column’s self-weight is included as a distributed axial compressive load in the ideal Euler model”, not “The material remains linearly elastic up to the buckling load” (different quantity, basis, or operating regime).\nD) Plane sections remain plane and shear deformation is neglected in the bending idealisation: Selecting “Plane sections remain plane and shear deformation is neglected in the bending idealisation” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “The column’s self-weight is included as a distributed axial compressive load in the ideal Euler model”, not “Plane sections remain plane and shear deformation is neglected in the bending idealisation” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Euler Pcr=π²EI/Le². Core assumptions: initially straight, concentric axial load, linear elasticity, small slopes, neglect shear deformation.\n• Self-weight as distributed axial load is NOT in the elementary Euler ideal column model.\n• End factors: hinged–hinged Le=L; fixed–fixed ideal Le=L/2; fixed–free Le=2L.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Rankine–Gordon: 1/Pr=1/Pc+1/Pe — use when crushing and buckling both matter.\n• Initial crookedness/eccentricity ⇒ use IS 800 column curves, not bare Euler.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
  ...
  },
  {
    ...
    "questionType": "Numerical",
    "formula": "",
    "explanation": "CORRECT: 95°C\n\nWHY CORRECT:\nΣ = 227.3 MPa = αEΔT → ΔT ≈ 94.7°C. This uniquely selects “95°C”. See per-option mechanisms under TRAP ANALYSIS.\n\nCALCULATION:\nσ = 227.3 MPa = αEΔT → ΔT ≈ 94.7°C.\nFinal keyed result: 95°C.\n\nTRAP ANALYSIS (every wrong option):\nA) 104°C: Selecting “104°C” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “95°C”, not “104°C” (different quantity, basis, or operating regime).\nB) 48°C: Classic ÷2 slip on “48°C” (halved length/share or used radius as diameter).\nC) 200°C: Selecting “200°C” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “95°C”, not “200°C” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Fixed-end heating: free expansion αΔTL fully suppressed ⇒ compressive σ=α E ΔT.\n• Onset vs design yield: set α E ΔT = fy/γm0 (Fe250⇒≈227 MPa), not bare fy=250.\n• α_steel≈12×10⁻⁶ /°C and E≈200 GPa are the usual exam constants.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• If one end can slip, stress < αEΔT (compatibility releases).\n• Composite rails: solve redundant force from unequal α or ΔT.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "questionType": "Numerical",
    "formula": "",
    "explanation": "CORRECT: 2.4×10⁵ mm³\n\nWHY CORRECT:\nZ = M/σ = 36×10⁶/150 = 2.4×10⁵ mm³. This uniquely selects “2.4×10⁵ mm³”. See per-option mechanisms under TRAP ANALYSIS.\n\nCALCULATION:\nZ = M/σ = 36×10⁶/150 = 2.4×10⁵ mm³.\nFinal keyed result: 2.4×10⁵ mm³.\n\nTRAP ANALYSIS (every wrong option):\nB) 2.4×10⁶ mm³: Selecting “2.4×10⁶ mm³” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “2.4×10⁵ mm³”, not “2.4×10⁶ mm³” (different quantity, basis, or operating regime).\nC) 5.4×10⁵ mm³: Squared a linear quantity to land on “5.4×10⁵ mm³” — wrong power of the governing variable.\nD) 150×10³ mm³: Selecting “150×10³ mm³” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “2.4×10⁵ mm³”, not “150×10³ mm³” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Required elastic Z = M/σ_allow with consistent units.\n• 36 kN·m = 36×10⁶ N·mm; σ=150 N/mm² ⇒ Z=36e6/150=2.4×10⁵ mm³.\n• Power-of-ten slip 2.4×10⁶ mm³ is the classic wrong option.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Rectangle Z=bd²/6; solve missing b or d when the other is fixed.\n• Plastic modulus for rectangle Zp=bd²/4 (>Z).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
  ...
  },
  {
    ...
    "questionType": "Conceptual",
    "formula": "",
    "explanation": "CORRECT: Radius rises; slenderness falls; buckling capacity rises\n\nWHY CORRECT:\nLarger weak-axis second moment raises radius, lowers slenderness and raises buckling resistance.\n\nCALCULATION:\nN/A — conceptual / judgement / matching / theory-assumptions (no arithmetic key).\n\nTRAP ANALYSIS (every wrong option):\nA) Radius decreases; slenderness decreases; capacity rises: Selecting “Radius decreases; slenderness decreases; capacity rises” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Radius rises; slenderness falls; buckling capacity rises”, not “Radius decreases; slenderness decreases; capacity rises” (different quantity, basis, or operating regime).\nB) All unchanged: Selecting “All unchanged” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Radius rises; slenderness falls; buckling capacity rises”, not “All unchanged” (different quantity, basis, or operating regime).\nC) Radius rises; slenderness rises; capacity falls: Selecting “Radius rises; slenderness rises; capacity falls” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Radius rises; slenderness falls; buckling capacity rises”, not “Radius rises; slenderness rises; capacity falls” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• r_min=√(I_min/A). Moving area away from the weak axis raises I_min and r_min at constant A.\n• λ=Le/r_min falls when r_min rises ⇒ buckling capacity rises.\n• Improving the strong-axis I while weak-axis I is unchanged does not help — weak axis still governs.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Adding a brace that shortens Le often raises capacity more than a small r gain.\n• Check which axis has smaller r before redesigning the shape.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "questionType": "Conceptual",
    "formula": "",
    "explanation": "CORRECT: Restore specified cover before concreting\n\nWHY CORRECT:\nDurability/fire cover is an independent requirement.\n\nCALCULATION:\nN/A — conceptual / judgement / matching / theory-assumptions (no arithmetic key).\n\nTRAP ANALYSIS (every wrong option):\nA) Accept because depth governs strength: Selecting “Accept because depth governs strength” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Restore specified cover before concreting”, not “Accept because depth governs strength” (different quantity, basis, or operating regime).\nB) Increase water-cement ratio: Selecting “Increase water-cement ratio” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Restore specified cover before concreting”, not “Increase water-cement ratio” (different quantity, basis, or operating regime).\nD) Replace stirrups with larger spacing: Selecting “Replace stirrups with larger spacing” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Restore specified cover before concreting”, not “Replace stirrups with larger spacing” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Nominal cover is a durability/fire limit independent of flexural strength depth.\n• If cover is short on site: restore chairs/spacers before pour — do not waive because ‘d is OK’.\n• Increasing w/c worsens durability; widening stirrup spacing hurts shear/confinement.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• d = D − cover − φ/2 (approx) — cover error also shifts effective depth.\n• Exposure class sets minimum cover (IS 456 table) — use the governing exposure.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "questionType": "Numerical",
    "formula": "",
    "explanation": "CORRECT: Under-reinforced because 225 mm is below 240 mm\n\nWHY CORRECT:\nLimiting depth = 0.48×500 = 240 mm; trial is lower.\n\nCALCULATION:\nlimiting depth = 0.48×500 = 240 mm; trial is lower.\nFinal keyed result: Under-reinforced because 225 mm is below 240 mm.\n\nTRAP ANALYSIS (every wrong option):\nB) Balanced because ratio is 0.50: Selecting “Balanced because ratio is 0.50” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Under-reinforced because 225 mm is below 240 mm”, not “Balanced because ratio is 0.50” (different quantity, basis, or operating regime).\nC) Over-reinforced because any depth above 200 mm fails: Selecting “Over-reinforced because any depth above 200 mm fails” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Under-reinforced because 225 mm is below 240 mm”, not “Over-reinforced because any depth above 200 mm fails” (different quantity, basis, or operating regime).\nD) Classification needs beam width only: Selecting “Classification needs beam width only” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Under-reinforced because 225 mm is below 240 mm”, not “Classification needs beam width only” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Fe415 limiting NA: xu,max/d ≈ 0.48. For d=500 mm → xu,max≈240 mm.\n• Trial xu=225 mm < 240 mm ⇒ under-reinforced (steel yields first) — preferred for ductility.\n• The xu vs xu,max test does not need breadth b.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Fe250 → xu,max/d≈0.53; Fe500 → ≈0.46.\n• If Mu demand > Mu,lim of singly reinforced section → go doubly reinforced.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "formula": "",
    "explanation": "CORRECT: Both true; R explains A\n\nWHY CORRECT:\nBoth support condition and aspect ratio establish two-way action.\n\nCALCULATION:\nN/A — conceptual / judgement / matching / theory-assumptions (no arithmetic key).\n\nTRAP ANALYSIS (every wrong option):\nA) Both true; R does not explain A: Selecting “Both true; R does not explain A” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Both true; R explains A”, not “Both true; R does not explain A” (different quantity, basis, or operating regime).\nB) A true, R false: Selecting “A true, R false” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Both true; R explains A”, not “A true, R false” (different quantity, basis, or operating regime).\nD) A false, R true: Selecting “A false, R true” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Both true; R explains A”, not “A false, R true” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Two-way action needs BOTH: support on four sides AND ly/lx ≤ 2.\n• Here lx=3.5 m, ly=5.0 m ⇒ ly/lx≈1.43 < 2 with four-edge support ⇒ two-way.\n• ly/lx>2 even on four supports ⇒ design as one-way spanning short side.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Short span lx carries the larger load share in two-way slabs.\n• Corners held down vs not held down changes torsion reinforcement detailing.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Diagram-Core/Family",
  ...
  },
  {
    ...
    "formula": "",
    "explanation": "CORRECT: Hold the pour locally, restore chairs/bar level and reverify cover and effective depth\n\nWHY CORRECT:\nDisplaced negative steel reduces support capacity and changes cover.\n\nCALCULATION:\nFinal keyed result: Hold the pour locally, restore chairs/bar level and reverify cover and effective depth.\n\nTRAP ANALYSIS (every wrong option):\nA) Continue because slab bottom steel is present: Selecting “Continue because slab bottom steel is present” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Hold the pour locally, restore chairs/bar level and reverify cover and effective depth”, not “Continue because slab bottom steel is present” (different quantity, basis, or operating regime).\nB) Add extra water for access: Selecting “Add extra water for access” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Hold the pour locally, restore chairs/bar level and reverify cover and effective depth”, not “Add extra water for access” (different quantity, basis, or operating regime).\nD) Record it only after stripping: Selecting “Record it only after stripping” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Hold the pour locally, restore chairs/bar level and reverify cover and effective depth”, not “Record it only after stripping” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “Hold the pour locally, restore chairs/bar level and reverify cover and effective depth”.\n• For reinforcement+practical+hold point: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same reinforcement+practical+hold point with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for reinforcement+practical+hold point (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "questionType": "Conceptual",
    "formula": "",
    "explanation": "CORRECT: Web width, unless another compression flange is specifically present\n\nWHY CORRECT:\nThe slab flange is not in compression under hogging.\n\nCALCULATION:\nN/A — conceptual / judgement / matching / theory-assumptions (no arithmetic key).\n\nTRAP ANALYSIS (every wrong option):\nA) Full slab width: Selecting “Full slab width” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Web width, unless another compression flange is specifically present”, not “Full slab width” (different quantity, basis, or operating regime).\nB) Midspan effective flange width: Selecting “Midspan effective flange width” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Web width, unless another compression flange is specifically present”, not “Midspan effective flange width” (different quantity, basis, or operating regime).\nC) Half panel width: Selecting “Half panel width” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Web width, unless another compression flange is specifically present”, not “Half panel width” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Fe415 limiting NA: xu,max/d ≈ 0.48. For d=500 mm → xu,max≈240 mm.\n• Trial xu=225 mm < 240 mm ⇒ under-reinforced (steel yields first) — preferred for ductility.\n• The xu vs xu,max test does not need breadth b.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Fe250 → xu,max/d≈0.53; Fe500 → ≈0.46.\n• If Mu demand > Mu,lim of singly reinforced section → go doubly reinforced.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "questionType": "Diagram+Conceptual",
    "formula": "",
    "explanation": "CORRECT: Detail S\n\nWHY CORRECT:\nDetail S uses a closed perimeter tie plus both crossties so every corner and mid-face bar is restrained.\n\nCALCULATION:\nN/A — conceptual / judgement / matching / theory-assumptions (no arithmetic key).\n\nTRAP ANALYSIS (every wrong option):\nA) Detail P: Selecting “Detail P” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Detail S”, not “Detail P” (different quantity, basis, or operating regime).\nB) Detail Q: Selecting “Detail Q” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Detail S”, not “Detail Q” (different quantity, basis, or operating regime).\nC) Detail R: Selecting “Detail R” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Detail S”, not “Detail R” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “Detail S”.\n• For column ties+diagram+detailing: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same column ties+diagram+detailing with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for column ties+diagram+detailing (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Diagram-Core/Family",
    "diagramSource": "schematic-family",
  ...
  },
  {
    ...
    "questionType": "Conceptual",
    "formula": "",
    "explanation": "CORRECT: Minimum shear reinforcement in X; designed shear reinforcement in Y\n\nWHY CORRECT:\nMinimum stirrups remain required in X; Y needs the balance carried by shear reinforcement.\n\nCALCULATION:\nN/A — conceptual / judgement / matching / theory-assumptions (no arithmetic key).\n\nTRAP ANALYSIS (every wrong option):\nA) No stirrups in either: Selecting “No stirrups in either” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Minimum shear reinforcement in X; designed shear reinforcement in Y”, not “No stirrups in either” (different quantity, basis, or operating regime).\nB) Redesign both sections immediately: Selecting “Redesign both sections immediately” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Minimum shear reinforcement in X; designed shear reinforcement in Y”, not “Redesign both sections immediately” (different quantity, basis, or operating regime).\nD) Provide torsion steel only in Y: Selecting “Provide torsion steel only in Y” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Minimum shear reinforcement in X; designed shear reinforcement in Y”, not “Provide torsion steel only in Y” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “Minimum shear reinforcement in X; designed shear reinforcement in Y”.\n• For IS shear+design judgement: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same IS shear+design judgement with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for IS shear+design judgement (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "questionType": "Conceptual",
    "formula": "",
    "explanation": "CORRECT: Extend the bar, provide an allowable hook/bend, or revise curtailment so anchorage and the related moment/shear checks are all satisfied\n\nWHY CORRECT:\nInadequate development is a structural limit, not a drafting preference.\n\nCALCULATION:\nN/A — conceptual / judgement / matching / theory-assumptions (no arithmetic key).\n\nTRAP ANALYSIS (every wrong option):\nA) Accept because the bar has already entered the support region: Selecting “Accept because the bar has already entered the support region” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Extend the bar, provide an allowable hook/bend, or revise curtailment so anchorage and the related moment/shear checks are all satisfied”, not “Accept because the bar has already entered the support region” (different quantity, basis, or operating regime).\nB) Increase only the clear cover and leave the cut-off unchanged: Selecting “Increase only the clear cover and leave the cut-off unchanged” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Extend the bar, provide an allowable hook/bend, or revise curtailment so anchorage and the related moment/shear checks are all satisfied”, not “Increase only the clear cover and leave the cut-off unchanged” (different quantity, basis, or operating regime).\nD) Replace stirrups with larger spacing to free anchorage length: Selecting “Replace stirrups with larger spacing to free anchorage length” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Extend the bar, provide an allowable hook/bend, or revise curtailment so anchorage and the related moment/shear checks are all satisfied”, not “Replace stirrups with larger spacing to free anchorage length” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “Extend the bar, provide an allowable hook/bend, or revise curtailment so anchorage and the related moment/shear checks are all satisfied”.\n• For IS anchorage+governing decision: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same IS anchorage+governing decision with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for IS anchorage+governing decision (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
  ...
  },
  {
    ...
    "questionType": "Conceptual",
    "formula": "",
    "explanation": "CORRECT: Introduce a compression-steel couple with additional tension steel to resist the excess, or else change the section/materials\n\nWHY CORRECT:\nMu > Mu,lim requires a steel couple or a larger section.\n\nCALCULATION:\nN/A — conceptual / judgement / matching / theory-assumptions (no arithmetic key).\n\nTRAP ANALYSIS (every wrong option):\nA) Provide only minimum tension steel and ignore the excess: Selecting “Provide only minimum tension steel and ignore the excess” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Introduce a compression-steel couple with additional tension steel to resist the excess, or else change the section/materials”, not “Provide only minimum tension steel and ignore the excess” (different quantity, basis, or operating regime).\nB) Treat the limiting singly reinforced capacity as a serviceability ceiling and stop: Selecting “Treat the limiting singly reinforced capacity as a serviceability ceiling and stop” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Introduce a compression-steel couple with additional tension steel to resist the excess, or else change the section/materials”, not “Treat the limiting singly reinforced capacity as a serviceability ceiling and stop” (different quantity, basis, or operating regime).\nD) Reduce the load factor instead of changing reinforcement: Selecting “Reduce the load factor instead of changing reinforcement” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Introduce a compression-steel couple with additional tension steel to resist the excess, or else change the section/materials”, not “Reduce the load factor instead of changing reinforcement” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “Introduce a compression-steel couple with additional tension steel to resist the excess, or else change the section/materials”.\n• For doubly reinforced+concept: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same doubly reinforced+concept with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for doubly reinforced+concept (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "formula": "",
    "explanation": "CORRECT: 0.52 MPa; stirrups carry the balance, subject to the maximum limit\n\nWHY CORRECT:\nMidpoint interpolation gives 0.52 MPa; demand exceeds it.\n\nCALCULATION:\nmidpoint interpolation gives 0.52 MPa; demand exceeds it.\nFinal keyed result: 0.52 MPa; stirrups carry the balance, subject to the maximum limit.\n\nTRAP ANALYSIS (every wrong option):\nA) 0.48 MPa; minimum stirrups only: Selecting “0.48 MPa; minimum stirrups only” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “0.52 MPa; stirrups carry the balance, subject to the maximum limit”, not “0.48 MPa; minimum stirrups only” (different quantity, basis, or operating regime).\nB) 0.56 MPa; no stirrups: Selecting “0.56 MPa; no stirrups” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “0.52 MPa; stirrups carry the balance, subject to the maximum limit”, not “0.56 MPa; no stirrups” (different quantity, basis, or operating regime).\nC) 0.70 MPa; concrete alone: Selecting “0.70 MPa; concrete alone” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “0.52 MPa; stirrups carry the balance, subject to the maximum limit”, not “0.70 MPa; concrete alone” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “0.52 MPa; stirrups carry the balance, subject to the maximum limit”.\n• For table+diagram+interpolation: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same table+diagram+interpolation with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for table+diagram+interpolation (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Diagram-Core/Family",
    "diagramSource": "core",
  ...
  },
  {
    ...
    "questionType": "Numerical",
    "formula": "",
    "explanation": "CORRECT: 260 mm\n\nWHY CORRECT:\nCeiling = 262.5 mm; adopt 260 mm. This uniquely selects “260 mm”. See per-option mechanisms under TRAP ANALYSIS.\n\nCALCULATION:\nceiling = 262.5 mm; adopt 260 mm.\nFinal keyed result: 260 mm.\n\nTRAP ANALYSIS (every wrong option):\nA) 300 mm: Selecting “300 mm” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “260 mm”, not “300 mm” (different quantity, basis, or operating regime).\nB) 280 mm: Selecting “280 mm” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “260 mm”, not “280 mm” (different quantity, basis, or operating regime).\nD) 350 mm: Selecting “350 mm” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “260 mm”, not “350 mm” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “260 mm”.\n• For IS stirrup spacing: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same IS stirrup spacing with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for IS stirrup spacing (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "questionType": "Practical/Application",
    "formula": "",
    "explanation": "CORRECT: Barricade and map the defect, assess section/bond, then execute an engineer-approved repair or strengthening method\n\nWHY CORRECT:\nCubes do not prove in-situ continuity or anchorage.\n\nCALCULATION:\nFinal keyed result: Barricade and map the defect, assess section/bond, then execute an engineer-approved repair or strengthening method.\n\nTRAP ANALYSIS (every wrong option):\nB) Apply rich plaster after wetting: Selecting “Apply rich plaster after wetting” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Barricade and map the defect, assess section/bond, then execute an engineer-approved repair or strengthening method”, not “Apply rich plaster after wetting” (different quantity, basis, or operating regime).\nC) Accept solely from cube results: Selecting “Accept solely from cube results” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Barricade and map the defect, assess section/bond, then execute an engineer-approved repair or strengthening method”, not “Accept solely from cube results” (different quantity, basis, or operating regime).\nD) Load the beam before documenting the defect: Selecting “Load the beam before documenting the defect” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Barricade and map the defect, assess section/bond, then execute an engineer-approved repair or strengthening method”, not “Load the beam before documenting the defect” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Nominal cover is a durability/fire limit independent of flexural strength depth.\n• If cover is short on site: restore chairs/spacers before pour — do not waive because ‘d is OK’.\n• Increasing w/c worsens durability; widening stirrup spacing hurts shear/confinement.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• d = D − cover − φ/2 (approx) — cover error also shifts effective depth.\n• Exposure class sets minimum cover (IS 456 table) — use the governing exposure.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "questionType": "Numerical+Diagram",
    "formula": "",
    "explanation": "CORRECT: 18.9 kPa\n\nWHY CORRECT:\nH=150 mm, x=y=200 mm, S_Hg=13.6, g=10. With equal limbs, p_A−p_B = h(ρ_Hg−ρ_w)g = 0.15×(13600−1000)×10 = 18900 Pa = 18.9 kPa.\n\nCALCULATION:\nh=150 mm, x=y=200 mm, S_Hg=13.6, g=10. With equal limbs, p_A−p_B = h(ρ_Hg−ρ_w)g = 0.15×(13600−1000)×10 = 18900 Pa = 18.9 kPa.\nFinal keyed result: 18.9 kPa.\n\nTRAP ANALYSIS (every wrong option):\nA) 8.4 kPa: Selecting “8.4 kPa” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “18.9 kPa”, not “8.4 kPa” (different quantity, basis, or operating regime).\nB) 12.6 kPa: Selecting “12.6 kPa” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “18.9 kPa”, not “12.6 kPa” (different quantity, basis, or operating regime).\nD) 25.2 kPa: Selecting “25.2 kPa” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “18.9 kPa”, not “25.2 kPa” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Equal limb elevations: pA−pB = h(ρm−ρ)g with h in metres.\n• SHg=13.6 ⇒ ρm=13600 kg/m³; h=0.15 m, g=10 → 0.15×(13600−1000)×10=18900 Pa=18.9 kPa.\n• Using (S−1)gh with wrong h (0.10 m) or dropping g produces the classic 12.6 kPa trap.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Inclined manometer: vertical head = L sinθ.\n• If limb elevations differ, add/subtract ρgΔz of the connecting fluid before the mercury term.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Diagram-Core/Family",
    "diagramSource": "schematic-family",
  ...
  },
  {
    ...
    "questionType": "Assertion-Reason",
    "formula": "",
    "explanation": "CORRECT: Both true; R explains A\n\nWHY CORRECT:\nThe momentum relation permits conjugate-depth analysis, while turbulence explains dissipation.\n\nCALCULATION:\nN/A — conceptual / judgement / matching / theory-assumptions (no arithmetic key).\n\nTRAP ANALYSIS (every wrong option):\nA) A true, R false: Selecting “A true, R false” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Both true; R explains A”, not “A true, R false” (different quantity, basis, or operating regime).\nB) Both true; R does not explain A: Selecting “Both true; R does not explain A” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Both true; R explains A”, not “Both true; R does not explain A” (different quantity, basis, or operating regime).\nC) A false, R true: Selecting “A false, R true” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Both true; R explains A”, not “A false, R true” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Concentrated couple ⇒ vertical jump in BMD; SFD stays continuous if no point force there.\n• Point force ⇒ jump in SFD (=force); BMD has a kink (slope change), not a jump.\n• EI change alters curvature M/EI only — it does not create equilibrium jumps on SFD/BMD.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• UDL start/stop ⇒ change in slope of SFD (dV/dx=−w), smooth change in BMD curvature.\n• Relations: dM/dx=V and dV/dx=−w diagnose diagram signatures.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-GATE→Transco"
  },
  {
    ...
    "questionType": "Numerical",
    "formula": "",
    "explanation": "CORRECT: Laminar\n\nWHY CORRECT:\nRe = VD/ν = 0.02×0.05/1e-6 = 1000 < 2300. This uniquely selects “Laminar”. See per-option mechanisms under TRAP ANALYSIS.\n\nCALCULATION:\nRe = VD/ν = 0.02×0.05/1e-6 = 1000 < 2300.\nFinal keyed result: Laminar.\n\nTRAP ANALYSIS (every wrong option):\nA) Turbulent: Selecting “Turbulent” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Laminar”, not “Turbulent” (different quantity, basis, or operating regime).\nB) Ideal/inviscid only: Selecting “Ideal/inviscid only” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Laminar”, not “Ideal/inviscid only” (different quantity, basis, or operating regime).\nD) Sonic: Selecting “Sonic” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Laminar”, not “Sonic” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “Laminar”.\n• For Reynolds regime+interpretation: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same Reynolds regime+interpretation with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for Reynolds regime+interpretation (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "questionType": "Graph+Application",
    "formula": "",
    "explanation": "CORRECT: The rising system head shifts each pump to a lower individual discharge\n\nWHY CORRECT:\nActual duty is the new pump-system intersection, not arithmetic addition at fixed head.\n\nCALCULATION:\nFinal keyed result: The rising system head shifts each pump to a lower individual discharge.\n\nTRAP ANALYSIS (every wrong option):\nB) Parallel operation halves static head: Selecting “Parallel operation halves static head” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “The rising system head shifts each pump to a lower individual discharge”, not “Parallel operation halves static head” (different quantity, basis, or operating regime).\nC) Pump speed automatically halves: Selecting “Pump speed automatically halves” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “The rising system head shifts each pump to a lower individual discharge”, not “Pump speed automatically halves” (different quantity, basis, or operating regime).\nD) Pipe area doubles: Selecting “Pipe area doubles” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “The rising system head shifts each pump to a lower individual discharge”, not “Pipe area doubles” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Operating point = intersection of pump curve(s) with the system curve — not arithmetic nameplate addition at fixed head.\n• Two identical pumps in parallel: total Q < 2× single-pump duty because the system head rises.\n• Static head is a system property; parallel operation does not halve static head.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Series pumps add head at a given Q; re-intersect the system curve.\n• Affinity: Q∝N, H∝N², P∝N³ under similarity.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Diagram-Core/Family",
    "diagramSource": "schematic-family",
  ...
  },
  {
    ...
    "questionType": "Conceptual",
    "formula": "",
    "explanation": "CORRECT: Pelton\n\nWHY CORRECT:\nAn impulse Pelton unit suits high head and low flow.\n\nCALCULATION:\nN/A — conceptual / judgement / matching / theory-assumptions (no arithmetic key).\n\nTRAP ANALYSIS (every wrong option):\nA) Kaplan: Selecting “Kaplan” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Pelton”, not “Kaplan” (different quantity, basis, or operating regime).\nB) Francis: Selecting “Francis” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Pelton”, not “Francis” (different quantity, basis, or operating regime).\nD) Propeller: Selecting “Propeller” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Pelton”, not “Propeller” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “Pelton”.\n• For turbine selection: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same turbine selection with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for turbine selection (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "questionType": "Diagram+Conceptual",
    "formula": "",
    "explanation": "CORRECT: Parabolic velocity; shear rising linearly to a wall maximum\n\nWHY CORRECT:\nFigure curves 2+C — no-slip Hagen–Poiseuille velocity is parabolic; Newtonian laminar pipe shear is zero on the centreline and rises linearly to a wall maximum.\n\nCALCULATION:\nfigure curves 2+C — no-slip Hagen–Poiseuille velocity is parabolic; Newtonian laminar pipe shear is zero on the centreline and rises linearly to a wall maximum.\nFinal keyed result: Parabolic velocity; shear rising linearly to a wall maximum.\n\nTRAP ANALYSIS (every wrong option):\nA) Flat velocity; maximum centreline shear: Selecting “Flat velocity; maximum centreline shear” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Parabolic velocity; shear rising linearly to a wall maximum”, not “Flat velocity; maximum centreline shear” (different quantity, basis, or operating regime).\nB) Parabolic velocity; zero wall shear: Selecting “Parabolic velocity; zero wall shear” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Parabolic velocity; shear rising linearly to a wall maximum”, not “Parabolic velocity; zero wall shear” (different quantity, basis, or operating regime).\nC) Linear velocity; uniform shear: Selecting “Linear velocity; uniform shear” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Parabolic velocity; shear rising linearly to a wall maximum”, not “Linear velocity; uniform shear” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Pipe laminar (Hagen–Poiseuille): u(r)=umax(1−(r/R)²) — parabola, no-slip at wall.\n• Newtonian laminar shear: τ(r)=τw·(r/R) — zero on centreline, maximum at wall.\n• Flat velocity ≈ turbulent core; linear u + uniform τ ≈ Couette — not this case.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Re=VD/ν; laminar if Re≲2000 for pipes.\n• Wall shear from force balance: τw=(ΔP)R/(2L).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Diagram-Core/Family",
    "diagramSource": "schematic-family",
  ...
  },
  {
    ...
    "questionType": "Numerical",
    "formula": "",
    "explanation": "CORRECT: 785 N, 7.85 kW\n\nWHY CORRECT:\nRelative speed 20 m/s → ṁ≈39.3 kg/s; F≈785 N; power=Fu≈7.85 kW.\n\nCALCULATION:\nrelative speed 20 m/s → ṁ≈39.3 kg/s; F≈785 N; power=Fu≈7.85 kW.\nFinal keyed result: 785 N, 7.85 kW.\n\nTRAP ANALYSIS (every wrong option):\nA) 900 N, 9.0 kW: Selecting “900 N, 9.0 kW” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “785 N, 7.85 kW”, not “900 N, 9.0 kW” (different quantity, basis, or operating regime).\nB) 1178 N, 11.8 kW: Selecting “1178 N, 11.8 kW” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “785 N, 7.85 kW”, not “1178 N, 11.8 kW” (different quantity, basis, or operating regime).\nC) 1571 N, 15.7 kW: Classic ×2 slip on “1571 N, 15.7 kW” (doubled length/load/share or used diameter as radius).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “785 N, 7.85 kW”.\n• For moving vane+momentum: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same moving vane+momentum with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for moving vane+momentum (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-GATE→Transco"
  },
  {
    ...
    "questionType": "Practical/Application",
    "formula": "",
    "explanation": "CORRECT: Cavitation\n\nWHY CORRECT:\nVapour formation and collapse at the eye produce the observed signature.\n\nCALCULATION:\nFinal keyed result: Cavitation.\n\nTRAP ANALYSIS (every wrong option):\nA) Water hammer at delivery valve: Selecting “Water hammer at delivery valve” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Cavitation”, not “Water hammer at delivery valve” (different quantity, basis, or operating regime).\nB) Bearing misalignment only: Selecting “Bearing misalignment only” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Cavitation”, not “Bearing misalignment only” (different quantity, basis, or operating regime).\nD) Laminar-flow transition: Selecting “Laminar-flow transition” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Cavitation”, not “Laminar-flow transition” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “Cavitation”.\n• For cavitation+practical diagnosis: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same cavitation+practical diagnosis with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for cavitation+practical diagnosis (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "questionType": "Numerical+Diagram",
    "formula": "",
    "explanation": "CORRECT: 2.4 kJ/kg\n\nWHY CORRECT:\nW = u(Vw1 − Vw2)/1000 = 40×(80 − 20)/1000 = 2.4 kJ/kg.\n\nCALCULATION:\nW = u(Vw1 − Vw2)/1000 = 40×(80 − 20)/1000 = 2.4 kJ/kg.\nFinal keyed result: 2.4 kJ/kg.\n\nTRAP ANALYSIS (every wrong option):\nA) 1.2 kJ/kg: Classic ÷2 slip on “1.2 kJ/kg” (halved length/share or used radius as diameter).\nC) 3.2 kJ/kg: Selecting “3.2 kJ/kg” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “2.4 kJ/kg”, not “3.2 kJ/kg” (different quantity, basis, or operating regime).\nD) 4.0 kJ/kg: Selecting “4.0 kJ/kg” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “2.4 kJ/kg”, not “4.0 kJ/kg” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Euler specific work W=u(Vw1−Vw2)/1000 kJ/kg when u,Vw are in m/s and Vw2 is same-sense as u.\n• This item: u=40, Vw1=80, Vw2=20 → W=40×60/1000=2.4 kJ/kg.\n• Omitting Vw2 → 3.2; adding Vw2 instead of subtracting → 4.0; half whirl change → 1.2.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• If Vw2 is opposite to blade motion, the sign flips to addition inside Euler’s equation.\n• Hydraulic efficiency definitions vary — read whether denominator is V1²/2 or gH.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Diagram-Core/Family",
    "diagramSource": "schematic-family",
  ...
  },
  {
    ...
    "questionType": "Numerical",
    "formula": "",
    "explanation": "CORRECT: 409 kN yielding\n\nWHY CORRECT:\nYielding ≈409 kN; rupture ≈428 kN; lesser governs.\n\nCALCULATION:\nyielding ≈409 kN; rupture ≈428 kN; lesser governs.\nFinal keyed result: 409 kN yielding.\n\nTRAP ANALYSIS (every wrong option):\nA) 428 kN rupture: Selecting “428 kN rupture” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “409 kN yielding”, not “428 kN rupture” (different quantity, basis, or operating regime).\nB) 450 kN yielding: Selecting “450 kN yielding” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “409 kN yielding”, not “450 kN yielding” (different quantity, basis, or operating regime).\nC) 380 kN rupture: Selecting “380 kN rupture” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “409 kN yielding”, not “380 kN rupture” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “409 kN yielding”.\n• For IS tension limit states: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same IS tension limit states with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for IS tension limit states (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
  ...
  },
  {
    ...
    "questionType": "Conceptual",
    "formula": "",
    "explanation": "CORRECT: The axis that produces the larger slenderness ratio Le/r governs the flexural-buckling strength\n\nWHY CORRECT:\nBuckling strength follows the larger slenderness demand.\n\nCALCULATION:\nN/A — conceptual / judgement / matching / theory-assumptions (no arithmetic key).\n\nTRAP ANALYSIS (every wrong option):\nA) The axis with the larger effective length always governs: Selecting “The axis with the larger effective length always governs” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “The axis that produces the larger slenderness ratio Le/r governs the flexural-buckling strength”, not “The axis with the larger effective length always governs” (different quantity, basis, or operating regime).\nB) The axis with the larger radius of gyration always governs: Selecting “The axis with the larger radius of gyration always governs” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “The axis that produces the larger slenderness ratio Le/r governs the flexural-buckling strength”, not “The axis with the larger radius of gyration always governs” (different quantity, basis, or operating regime).\nD) Both axes may be ignored if the section is compact: Selecting “Both axes may be ignored if the section is compact” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “The axis that produces the larger slenderness ratio Le/r governs the flexural-buckling strength”, not “Both axes may be ignored if the section is compact” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “The axis that produces the larger slenderness ratio Le/r governs the flexural-buckling strength”.\n• For column buckling+governing axis: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same column buckling+governing axis with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for column buckling+governing axis (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "questionType": "Conceptual",
    "formula": "",
    "explanation": "CORRECT: Throat\n\nWHY CORRECT:\nThis is effective throat geometry. This uniquely selects “Throat”. See per-option mechanisms under TRAP ANALYSIS.\n\nCALCULATION:\nN/A — conceptual / judgement / matching / theory-assumptions (no arithmetic key).\n\nTRAP ANALYSIS (every wrong option):\nB) Leg: Selecting “Leg” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Throat”, not “Leg” (different quantity, basis, or operating regime).\nC) Toe: Selecting “Toe” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Throat”, not “Toe” (different quantity, basis, or operating regime).\nD) Root gap: Selecting “Root gap” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Throat”, not “Root gap” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “Throat”.\n• For fillet weld terminology: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same fillet weld terminology with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for fillet weld terminology (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "questionType": "Conceptual",
    "formula": "",
    "explanation": "CORRECT: Section type, axis of buckling and fabrication class together select the buckling curve\n\nWHY CORRECT:\nIS curve selection depends on section/axis/imperfection class.\n\nCALCULATION:\nN/A — conceptual / judgement / matching / theory-assumptions (no arithmetic key).\n\nTRAP ANALYSIS (every wrong option):\nB) Yield stress alone fixes the curve for every section: Selecting “Yield stress alone fixes the curve for every section” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Section type, axis of buckling and fabrication class together select the buckling curve”, not “Yield stress alone fixes the curve for every section” (different quantity, basis, or operating regime).\nC) Any curve may be used if λ < 40: Selecting “Any curve may be used if λ < 40” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Section type, axis of buckling and fabrication class together select the buckling curve”, not “Any curve may be used if λ < 40” (different quantity, basis, or operating regime).\nD) Curves apply only to angles: Selecting “Curves apply only to angles” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Section type, axis of buckling and fabrication class together select the buckling curve”, not “Curves apply only to angles” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Fe415 limiting NA: xu,max/d ≈ 0.48. For d=500 mm → xu,max≈240 mm.\n• Trial xu=225 mm < 240 mm ⇒ under-reinforced (steel yields first) — preferred for ductility.\n• The xu vs xu,max test does not need breadth b.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Fe250 → xu,max/d≈0.53; Fe500 → ≈0.46.\n• If Mu demand > Mu,lim of singly reinforced section → go doubly reinforced.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "questionType": "Conceptual",
    "formula": "",
    "explanation": "CORRECT: About 1.12 My\n\nWHY CORRECT:\nMp = Zp fy ≈ (shape factor)×My for the same fy. This uniquely selects “About 1.12 My”. See per-option mechanisms under TRAP ANALYSIS.\n\nCALCULATION:\nMp = Zp fy ≈ (shape factor)×My for the same fy.\nFinal keyed result: About 1.12 My.\n\nTRAP ANALYSIS (every wrong option):\nB) Equal to My always: Selecting “Equal to My always” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “About 1.12 My”, not “Equal to My always” (different quantity, basis, or operating regime).\nC) 0.5 My: Selecting “0.5 My” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “About 1.12 My”, not “0.5 My” (different quantity, basis, or operating regime).\nD) Twice My for all I-sections: Selecting “Twice My for all I-sections” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “About 1.12 My”, not “Twice My for all I-sections” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “About 1.12 My”.\n• For plastic moment+section capacity: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same plastic moment+section capacity with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for plastic moment+section capacity (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-GATE→Transco"
  },
  {
    ...
    "questionType": "Diagram+Conceptual",
    "formula": "",
    "explanation": "CORRECT: Q, 1810 mm²\n\nWHY CORRECT:\nPath P: An=(240−2×22)×10=1960 mm². Path Q: credits 2×(30²)/(4×60)=7.5 mm → An=(240−66+7.5)×10≈1815 mm² ≈1810. Adopt smaller An → Q.\n\nCALCULATION:\nPath P: An=(240−2×22)×10=1960 mm². Path Q: credits 2×(30²)/(4×60)=7.5 mm → An=(240−66+7.5)×10≈1815 mm² ≈1810. Adopt smaller An → Q.\nFinal keyed result: Q, 1810 mm².\n\nTRAP ANALYSIS (every wrong option):\nA) P, 1960 mm²: Selecting “P, 1960 mm²” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Q, 1810 mm²”, not “P, 1960 mm²” (different quantity, basis, or operating regime).\nB) P, 1740 mm²: Selecting “P, 1740 mm²” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Q, 1810 mm²”, not “P, 1740 mm²” (different quantity, basis, or operating regime).\nC) Q, 2030 mm²: Selecting “Q, 2030 mm²” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Q, 1810 mm²”, not “Q, 2030 mm²” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Net area An=[b − n·dh + Σ(s²/(4g))]·t ; adopt the path with the smaller An.\n• Chain path: no stagger credit. Zig-zag path: add each s²/(4g) along that path.\n• With b=240, t=10, dh=22: path P (2 holes)=1960 mm²; path Q (3 holes + two s=30 on g=60)≈1815≈1810 mm² → adopt Q.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Block shear is a different failure path (shear+tension) — compare separately.\n• Stagger credit cannot make An exceed gross area bt.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Diagram-Core/Family",
    "diagramSource": "schematic-family",
  ...
  },
  {
    ...
    "questionType": "Numerical",
    "formula": "",
    "explanation": "CORRECT: Revise pitch to at least 50 mm\n\nWHY CORRECT:\nMinimum = 50 mm. This uniquely selects “Revise pitch to at least 50 mm”. See per-option mechanisms under TRAP ANALYSIS.\n\nCALCULATION:\nminimum = 50 mm.\nFinal keyed result: Revise pitch to at least 50 mm.\n\nTRAP ANALYSIS (every wrong option):\nA) Accept 45 mm because it exceeds twice diameter: Selecting “Accept 45 mm because it exceeds twice diameter” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Revise pitch to at least 50 mm”, not “Accept 45 mm because it exceeds twice diameter” (different quantity, basis, or operating regime).\nB) Reduce hole diameter only: Selecting “Reduce hole diameter only” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Revise pitch to at least 50 mm”, not “Reduce hole diameter only” (different quantity, basis, or operating regime).\nC) Accept if plate is thicker than bolt: Selecting “Accept if plate is thicker than bolt” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Revise pitch to at least 50 mm”, not “Accept if plate is thicker than bolt” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• In-plane eccentricity: each bolt gets primary shear P/n plus secondary shear (M ri)/Σr² with M=P·e.\n• Critical bolt = largest vector sum of primary and secondary components — not automatically the farthest bolt.\n• Compute about the bolt-group centroid.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Out-of-plane brackets: bolts in tension+shear → interaction (Vb/Vdb)²+(Tb/Tdb)²≤1.\n• Still check pitch, gauge, edge distance after force sizing.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "questionType": "Conceptual",
    "formula": "",
    "explanation": "CORRECT: Grind/repair to approved procedure, re-inspect, then accept only if limits are met\n\nWHY CORRECT:\nUndercut is a rejectable discontinuity on a primary path until repaired to procedure.\n\nCALCULATION:\nN/A — conceptual / judgement / matching / theory-assumptions (no arithmetic key).\n\nTRAP ANALYSIS (every wrong option):\nB) Accept because the throat looks large: Selecting “Accept because the throat looks large” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Grind/repair to approved procedure, re-inspect, then accept only if limits are met”, not “Accept because the throat looks large” (different quantity, basis, or operating regime).\nC) Fill undercut with paint only: Selecting “Fill undercut with paint only” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Grind/repair to approved procedure, re-inspect, then accept only if limits are met”, not “Fill undercut with paint only” (different quantity, basis, or operating regime).\nD) Ignore undercut on the compression side always: Selecting “Ignore undercut on the compression side always” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Grind/repair to approved procedure, re-inspect, then accept only if limits are met”, not “Ignore undercut on the compression side always” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “Grind/repair to approved procedure, re-inspect, then accept only if limits are met”.\n• For weld quality+site acceptance: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same weld quality+site acceptance with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for weld quality+site acceptance (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "questionType": "Conceptual",
    "formula": "",
    "explanation": "CORRECT: Weak-axis (larger λ) flexural buckling\n\nWHY CORRECT:\nThe larger Le/r governs flexural-buckling strength.\n\nCALCULATION:\nN/A — conceptual / judgement / matching / theory-assumptions (no arithmetic key).\n\nTRAP ANALYSIS (every wrong option):\nA) Strong-axis curve only: Selecting “Strong-axis curve only” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Weak-axis (larger λ) flexural buckling”, not “Strong-axis curve only” (different quantity, basis, or operating regime).\nB) Local flange buckling only: Selecting “Local flange buckling only” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Weak-axis (larger λ) flexural buckling”, not “Local flange buckling only” (different quantity, basis, or operating regime).\nC) Shear buckling of the web only: Selecting “Shear buckling of the web only” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Weak-axis (larger λ) flexural buckling”, not “Shear buckling of the web only” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• λ = Le / r_min with Le and r in the SAME unit (convert 2.1 m → 2100 mm before dividing by 35 mm).\n• If the stem already gives effective length Le, do NOT multiply again by end-factor K.\n• Larger r_min ⇒ smaller λ ⇒ higher buckling strength (for the same Le).\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Both-ends-fixed ideal K=0.5 (IS often ~0.65 practical) → Le=K·L_geo, then λ=Le/r.\n• If r is halved, λ doubles (e.g. 60 → 120) — classic distractor.\n• Euler assumes straight + concentric + elastic; crookedness/eccentricity voids bare Euler.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "questionType": "Conceptual",
    "formula": "",
    "explanation": "CORRECT: Biaxial bending interaction with stability and serviceability checks\n\nWHY CORRECT:\nOblique loading resolves about both axes, and restraint affects stability.\n\nCALCULATION:\nN/A — conceptual / judgement / matching / theory-assumptions (no arithmetic key).\n\nTRAP ANALYSIS (every wrong option):\nA) Major-axis bending only: Selecting “Major-axis bending only” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Biaxial bending interaction with stability and serviceability checks”, not “Major-axis bending only” (different quantity, basis, or operating regime).\nB) Axial tension only: Selecting “Axial tension only” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Biaxial bending interaction with stability and serviceability checks”, not “Axial tension only” (different quantity, basis, or operating regime).\nC) Minor-axis bending only: Selecting “Minor-axis bending only” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Biaxial bending interaction with stability and serviceability checks”, not “Minor-axis bending only” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “Biaxial bending interaction with stability and serviceability checks”.\n• For biaxial purlin design: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same biaxial purlin design with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for biaxial purlin design (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "questionType": "Conceptual",
    "formula": "",
    "explanation": "CORRECT: Reduced net stress increase and settlement demand\n\nWHY CORRECT:\nExcavated soil weight offsets part of structural pressure; it does not cancel gross pressure or eliminate geotechnical checks.\n\nCALCULATION:\nN/A — conceptual / judgement / matching / theory-assumptions (no arithmetic key).\n\nTRAP ANALYSIS (every wrong option):\nA) Guaranteed absence of heave: Selecting “Guaranteed absence of heave” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Reduced net stress increase and settlement demand”, not “Guaranteed absence of heave” (different quantity, basis, or operating regime).\nB) Zero gross contact pressure: Selecting “Zero gross contact pressure” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Reduced net stress increase and settlement demand”, not “Zero gross contact pressure” (different quantity, basis, or operating regime).\nC) No bearing-capacity check: Selecting “No bearing-capacity check” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Reduced net stress increase and settlement demand”, not “No bearing-capacity check” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “Reduced net stress increase and settlement demand”.\n• For compensated raft: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same compensated raft with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for compensated raft (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-GATE→Transco"
  },
  {
    ...
    "questionType": "Numerical+Diagram",
    "formula": "",
    "explanation": "CORRECT: 95 mm\n\nWHY CORRECT:\nSc1=0.20×2.0/(1+1.00)×log10(2)=0.0602 m≈60 mm; Sc2=0.20×2.0/(1+0.90)×log10(300/200)≈0.0371 m≈37 mm; total ≈97 mm → closest 95 mm.\n\nCALCULATION:\nSc1=0.20×2.0/(1+1.00)×log10(2)=0.0602 m≈60 mm; Sc2=0.20×2.0/(1+0.90)×log10(300/200)≈0.0371 m≈37 mm; total ≈97 mm → closest 95 mm.\nFinal keyed result: 95 mm.\n\nTRAP ANALYSIS (every wrong option):\nA) 42 mm: Selecting “42 mm” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “95 mm”, not “42 mm” (different quantity, basis, or operating regime).\nB) 68 mm: Selecting “68 mm” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “95 mm”, not “68 mm” (different quantity, basis, or operating regime).\nC) 126 mm: Selecting “126 mm” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “95 mm”, not “126 mm” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Primary consolidation per layer: Sc=[Cc·H/(1+e0)]·log10((σ′0+Δσ)/σ′0); sum layers.\n• Use log10 (not ln). Wrong Δσ or σ′0 on a layer is the usual trap.\n• NC clay uses Cc; OC clay may use Cr until preconsolidation pressure.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Time: Tv=cv t / d²; double drainage halves d ⇒ time /4 for same U.\n• Sand: immediate settlement dominates; clay: consolidation often governs.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Diagram-Core/Family",
    "diagramSource": "schematic-family",
  ...
  },
  {
    ...
    "questionType": "Conceptual",
    "formula": "",
    "explanation": "CORRECT: Combined or strap footing designed about the load resultant\n\nWHY CORRECT:\nCoupling controls eccentricity and soil-pressure distribution without trespass.\n\nCALCULATION:\nN/A — conceptual / judgement / matching / theory-assumptions (no arithmetic key).\n\nTRAP ANALYSIS (every wrong option):\nA) Smaller eccentric isolated footing: Selecting “Smaller eccentric isolated footing” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Combined or strap footing designed about the load resultant”, not “Smaller eccentric isolated footing” (different quantity, basis, or operating regime).\nC) Unconnected pedestal: Selecting “Unconnected pedestal” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Combined or strap footing designed about the load resultant”, not “Unconnected pedestal” (different quantity, basis, or operating regime).\nD) Interior-column pile only: Selecting “Interior-column pile only” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Combined or strap footing designed about the load resultant”, not “Interior-column pile only” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “Combined or strap footing designed about the load resultant”.\n• For property line+selection: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same property line+selection with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for property line+selection (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "questionType": "Conceptual",
    "formula": "",
    "explanation": "CORRECT: Bearing may pass while settlement still governs; enlarge/deepen the footing, improve the ground, or revise until both criteria are satisfied\n\nWHY CORRECT:\nBearing capacity and settlement are independent acceptance criteria.\n\nCALCULATION:\nN/A — conceptual / judgement / matching / theory-assumptions (no arithmetic key).\n\nTRAP ANALYSIS (every wrong option):\nB) Accept because bearing pressure governs all foundation checks: Selecting “Accept because bearing pressure governs all foundation checks” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Bearing may pass while settlement still governs; enlarge/deepen the footing, improve the ground, or revise until both criteria are satisfied”, not “Accept because bearing pressure governs all foundation checks” (different quantity, basis, or operating regime).\nC) Reduce only the concrete grade of the footing: Selecting “Reduce only the concrete grade of the footing” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Bearing may pass while settlement still governs; enlarge/deepen the footing, improve the ground, or revise until both criteria are satisfied”, not “Reduce only the concrete grade of the footing” (different quantity, basis, or operating regime).\nD) Ignore settlement for footings shallower than 1.5 m: Selecting “Ignore settlement for footings shallower than 1.5 m” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Bearing may pass while settlement still governs; enlarge/deepen the footing, improve the ground, or revise until both criteria are satisfied”, not “Ignore settlement for footings shallower than 1.5 m” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Primary consolidation per layer: Sc=[Cc·H/(1+e0)]·log10((σ′0+Δσ)/σ′0); sum layers.\n• Use log10 (not ln). Wrong Δσ or σ′0 on a layer is the usual trap.\n• NC clay uses Cc; OC clay may use Cr until preconsolidation pressure.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Time: Tv=cv t / d²; double drainage halves d ⇒ time /4 for same U.\n• Sand: immediate settlement dominates; clay: consolidation often governs.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
  ...
  },
  {
    ...
    "questionType": "Diagram+Conceptual",
    "formula": "",
    "explanation": "CORRECT: Compare individual sum with block capacity, adopt the lower, then check settlement\n\nWHY CORRECT:\nClose spacing permits block action; settlement remains separate.\n\nCALCULATION:\nN/A — conceptual / judgement / matching / theory-assumptions (no arithmetic key).\n\nTRAP ANALYSIS (every wrong option):\nA) Use individual-pile sum only: Selecting “Use individual-pile sum only” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Compare individual sum with block capacity, adopt the lower, then check settlement”, not “Use individual-pile sum only” (different quantity, basis, or operating regime).\nC) Use block capacity only and ignore settlement: Selecting “Use block capacity only and ignore settlement” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Compare individual sum with block capacity, adopt the lower, then check settlement”, not “Use block capacity only and ignore settlement” (different quantity, basis, or operating regime).\nD) Assume group efficiency exceeds unity: Efficiency is output/input — wrong figure of merit for this stem.\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Close spacing (e.g. s=3D): compute BOTH ΣQ_individual and block capacity; adopt the lesser.\n• Settlement of the group is a separate serviceability check — not skipped when capacity governs.\n• Do not assume group efficiency η>1 without a stated basis.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Block capacity in clay ≈ perimeter cohesion×length×α + tip on block area (method as per stem).\n• Negative skin friction when surrounding fill settles around piles.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Diagram-Core/Family",
    "diagramSource": "schematic-family",
  ...
  },
  {
    ...
    "formula": "",
    "explanation": "CORRECT: 307 kPa\n\nWHY CORRECT:\nFrom 11 to 25 mm over 100 kPa, one additional millimetre gives about 7.1 kPa; ≈307 kPa.\n\nCALCULATION:\nfrom 11 to 25 mm over 100 kPa, one additional millimetre gives about 7.1 kPa; ≈307 kPa.\nFinal keyed result: 307 kPa.\n\nTRAP ANALYSIS (every wrong option):\nA) 300 kPa: Selecting “300 kPa” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “307 kPa”, not “300 kPa” (different quantity, basis, or operating regime).\nB) 400 kPa: Selecting “400 kPa” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “307 kPa”, not “400 kPa” (different quantity, basis, or operating regime).\nC) 325 kPa: Selecting “325 kPa” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “307 kPa”, not “325 kPa” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “307 kPa”.\n• For plate-load table+interpretation: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same plate-load table+interpretation with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for plate-load table+interpretation (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC",
    "dataTable": {
  ...
  },
  {
    ...
    "questionType": "Numerical",
    "formula": "",
    "explanation": "CORRECT: 450 kN\n\nWHY CORRECT:\nNet =12 mm; settlement criterion ≈750 kN, but separate cap =450 kN.\n\nCALCULATION:\nnet =12 mm; settlement criterion ≈750 kN, but separate cap =450 kN.\nFinal keyed result: 450 kN.\n\nTRAP ANALYSIS (every wrong option):\nA) 900 kN: Classic ×2 slip on “900 kN” (doubled length/load/share or used diameter as radius).\nB) 750 kN: Selecting “750 kN” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “450 kN”, not “750 kN” (different quantity, basis, or operating regime).\nD) 300 kN: Selecting “300 kN” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “450 kN”, not “300 kN” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Close spacing (e.g. s=3D): compute BOTH ΣQ_individual and block capacity; adopt the lesser.\n• Settlement of the group is a separate serviceability check — not skipped when capacity governs.\n• Do not assume group efficiency η>1 without a stated basis.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Block capacity in clay ≈ perimeter cohesion×length×α + tip on block area (method as per stem).\n• Negative skin friction when surrounding fill settles around piles.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
  ...
  },
  {
    ...
    "questionType": "Conceptual",
    "formula": "",
    "explanation": "CORRECT: Transfer moment so footing reactions are better centred\n\nWHY CORRECT:\nThe strap couples footing moments/reactions. This uniquely selects “Transfer moment so footing reactions are better centred”. See per-option mechanisms under TRAP ANALYSIS.\n\nCALCULATION:\nN/A — conceptual / judgement / matching / theory-assumptions (no arithmetic key).\n\nTRAP ANALYSIS (every wrong option):\nA) Drain groundwater: Selecting “Drain groundwater” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Transfer moment so footing reactions are better centred”, not “Drain groundwater” (different quantity, basis, or operating regime).\nB) Carry uniform soil pressure as a raft: Selecting “Carry uniform soil pressure as a raft” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Transfer moment so footing reactions are better centred”, not “Carry uniform soil pressure as a raft” (different quantity, basis, or operating regime).\nD) Remove the exterior column load: Selecting “Remove the exterior column load” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Transfer moment so footing reactions are better centred”, not “Remove the exterior column load” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “Transfer moment so footing reactions are better centred”.\n• For strap action: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same strap action with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for strap action (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "questionType": "Numerical+Diagram",
    "formula": "",
    "explanation": "CORRECT: \\(8×10^{-5}\\) m³/s\n\nWHY CORRECT:\n\\(kH(N_f/N_d)=4×10^{-5}×6×4/12=8×10^{-5}\\). This uniquely selects “\\(8×10^{-5}\\) m³/s”. See per-option mechanisms under TRAP ANALYSIS.\n\nCALCULATION:\n\\(kH(N_f/N_d)=4×10^{-5}×6×4/12=8×10^{-5}\\).\nFinal keyed result: \\(8×10^{-5}\\) m³/s.\n\nTRAP ANALYSIS (every wrong option):\nB) \\(2.4×10^{-4}\\) m³/s: Selecting “\\(2.4×10^{-4}\\) m³/s” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “\\(8×10^{-5}\\) m³/s”, not “\\(2.4×10^{-4}\\) m³/s” (different quantity, basis, or operating regime).\nC) \\(1.2×10^{-4}\\) m³/s: Selecting “\\(1.2×10^{-4}\\) m³/s” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “\\(8×10^{-5}\\) m³/s”, not “\\(1.2×10^{-4}\\) m³/s” (different quantity, basis, or operating regime).\nD) \\(4×10^{-5}\\) m³/s: Classic ÷2 slip on “\\(4×10^{-5}\\) m³/s” (halved length/share or used radius as diameter).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Discharge per unit width q = k H (Nf/Nd).\n• With k=4×10⁻⁵, H=6, Nf=4, Nd=12 → q=4e-5·6·4/12=8×10⁻⁵ m³/s.\n• Omitting /Nd inflates q (e.g. to 2.4×10⁻⁴) — classic trap.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Exit gradient ie=Δh/Δl at exit; compare with ic=(G−1)/(1+e).\n• Deeper sheet-pile embedment usually increases Nd and lowers q and ie.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Diagram-Core/Family",
    "diagramSource": "core",
  ...
  },
  {
    ...
    "questionType": "Numerical",
    "formula": "",
    "explanation": "CORRECT: 16.0 kN/m³, 82%\n\nWHY CORRECT:\nDry =16.0; e≈0.655; S≈82.4%. This uniquely selects “16.0 kN/m³, 82%”. See per-option mechanisms under TRAP ANALYSIS.\n\nCALCULATION:\ndry =16.0; e≈0.655; S≈82.4%.\nFinal keyed result: 16.0 kN/m³, 82%.\n\nTRAP ANALYSIS (every wrong option):\nB) 15.4 kN/m³, 75%: Selecting “15.4 kN/m³, 75%” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “16.0 kN/m³, 82%”, not “15.4 kN/m³, 75%” (different quantity, basis, or operating regime).\nC) 17.0 kN/m³, 96%: Selecting “17.0 kN/m³, 96%” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “16.0 kN/m³, 82%”, not “17.0 kN/m³, 96%” (different quantity, basis, or operating regime).\nD) 19.2 kN/m³, 100%: Selecting “19.2 kN/m³, 100%” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “16.0 kN/m³, 82%”, not “19.2 kN/m³, 100%” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “16.0 kN/m³, 82%”.\n• For phase relations+numerical: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same phase relations+numerical with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for phase relations+numerical (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "questionType": "Numerical",
    "formula": "",
    "explanation": "CORRECT: 27%\n\nWHY CORRECT:\n48−21 =27%. This uniquely selects “27%”. See per-option mechanisms under TRAP ANALYSIS.\n\nCALCULATION:\n48−21 =27%.\nFinal keyed result: 27%.\n\nTRAP ANALYSIS (every wrong option):\nA) 69%: Selecting “69%” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “27%”, not “69%” (different quantity, basis, or operating regime).\nC) 21%: Selecting “21%” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “27%”, not “21%” (different quantity, basis, or operating regime).\nD) 2.29%: Selecting “2.29%” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “27%”, not “2.29%” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “27%”.\n• For Atterberg limits: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same Atterberg limits with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for Atterberg limits (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "questionType": "Conceptual",
    "formula": "",
    "explanation": "CORRECT: Add hydrostatic pressure and recompute effective-stress soil pressure; total lateral demand generally rises markedly\n\nWHY CORRECT:\nWater pressure is superposed on effective soil pressure.\n\nCALCULATION:\nN/A — conceptual / judgement / matching / theory-assumptions (no arithmetic key).\n\nTRAP ANALYSIS (every wrong option):\nB) Soil thrust becomes zero because submerged unit weight is lower: Selecting “Soil thrust becomes zero because submerged unit weight is lower” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Add hydrostatic pressure and recompute effective-stress soil pressure; total lateral demand generally rises markedly”, not “Soil thrust becomes zero because submerged unit weight is lower” (different quantity, basis, or operating regime).\nC) Only wall self-weight changes: Selecting “Only wall self-weight changes” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Add hydrostatic pressure and recompute effective-stress soil pressure; total lateral demand generally rises markedly”, not “Only wall self-weight changes” (different quantity, basis, or operating regime).\nD) Active coefficient becomes unity automatically: Selecting “Active coefficient becomes unity automatically” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Add hydrostatic pressure and recompute effective-stress soil pressure; total lateral demand generally rises markedly”, not “Active coefficient becomes unity automatically” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “Add hydrostatic pressure and recompute effective-stress soil pressure; total lateral demand generally rises markedly”.\n• For retaining wall+water pressure: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same retaining wall+water pressure with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for retaining wall+water pressure (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "questionType": "Numerical",
    "formula": "",
    "explanation": "CORRECT: 16 years\n\nWHY CORRECT:\nDrainage path doubles, so time becomes fourfold =16 years.\n\nCALCULATION:\ndrainage path doubles, so time becomes fourfold =16 years.\nFinal keyed result: 16 years.\n\nTRAP ANALYSIS (every wrong option):\nA) 2 years: Selecting “2 years” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “16 years”, not “2 years” (different quantity, basis, or operating regime).\nB) 8 years: Classic ÷2 slip on “8 years” (halved length/share or used radius as diameter).\nD) 4 years: Selecting “4 years” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “16 years”, not “4 years” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Primary consolidation per layer: Sc=[Cc·H/(1+e0)]·log10((σ′0+Δσ)/σ′0); sum layers.\n• Use log10 (not ln). Wrong Δσ or σ′0 on a layer is the usual trap.\n• NC clay uses Cc; OC clay may use Cr until preconsolidation pressure.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Time: Tv=cv t / d²; double drainage halves d ⇒ time /4 for same U.\n• Sand: immediate settlement dominates; clay: consolidation often governs.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-GATE→Transco"
  },
  {
    ...
    "questionType": "Numerical",
    "formula": "",
    "explanation": "CORRECT: 1.00\n\nWHY CORRECT:\n\\((2.65−1)/(1+0.65)=1.0\\). This uniquely selects “1.00”. See per-option mechanisms under TRAP ANALYSIS.\n\nCALCULATION:\n\\((2.65−1)/(1+0.65)=1.0\\).\nFinal keyed result: 1.00.\n\nTRAP ANALYSIS (every wrong option):\nA) 0.65: Selecting “0.65” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “1.00”, not “0.65” (different quantity, basis, or operating regime).\nC) 1.65: Selecting “1.65” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “1.00”, not “1.65” (different quantity, basis, or operating regime).\nD) 2.65: Selecting “2.65” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “1.00”, not “2.65” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “1.00”.\n• For critical gradient: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same critical gradient with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for critical gradient (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
    ...
    "questionType": "Graph+Application",
    "formula": "",
    "explanation": "CORRECT: Higher effort gives higher maximum dry density/lower OMC, but F fails the shown relative-compaction criterion\n\nWHY CORRECT:\nHigher effort raises MDD and lowers OMC; F is below the 95% MDD acceptance line of the higher-effort curve.\n\nCALCULATION:\nhigher effort raises MDD and lowers OMC; F is below the 95% MDD acceptance line of the higher-effort curve.\nFinal keyed result: Higher effort gives higher maximum dry density/lower OMC, but F fails the shown relative-compaction criterion.\n\nTRAP ANALYSIS (every wrong option):\nA) Higher effort lowers maximum dry density: Selecting “Higher effort lowers maximum dry density” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Higher effort gives higher maximum dry density/lower OMC, but F fails the shown relative-compaction criterion”, not “Higher effort lowers maximum dry density” (different quantity, basis, or operating regime).\nB) F lies above the zero-air-void line: Selecting “F lies above the zero-air-void line” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Higher effort gives higher maximum dry density/lower OMC, but F fails the shown relative-compaction criterion”, not “F lies above the zero-air-void line” (different quantity, basis, or operating regime).\nC) Effort does not shift OMC: Selecting “Effort does not shift OMC” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “Higher effort gives higher maximum dry density/lower OMC, but F fails the shown relative-compaction criterion”, not “Effort does not shift OMC” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Higher compactive effort → higher MDD and lower OMC (curve shifts up and left).\n• Relative compaction = (γd,field / γd,MDD)×100%; many specs require ≥95% of the governing MDD.\n• No valid soil state plots above the zero-air-voids line.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Know whether acceptance uses standard or modified Proctor MDD.\n• Field γd from sand-replacement/core-cutter + water content.",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Diagram-Core/Family",
    "diagramSource": "schematic-family",
  ...
  },
  {
    ...
    "questionType": "Numerical",
    "formula": "",
    "explanation": "CORRECT: 48 kN/m\n\nWHY CORRECT:\nKa=1/3; thrust = 0.5×(1/3)×18×16 = 48 kN/m. This uniquely selects “48 kN/m”. See per-option mechanisms under TRAP ANALYSIS.\n\nCALCULATION:\nKa=1/3; thrust = 0.5×(1/3)×18×16 = 48 kN/m.\nFinal keyed result: 48 kN/m.\n\nTRAP ANALYSIS (every wrong option):\nA) 54 kN/m: Selecting “54 kN/m” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “48 kN/m”, not “54 kN/m” (different quantity, basis, or operating regime).\nC) 72 kN/m: Selecting “72 kN/m” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “48 kN/m”, not “72 kN/m” (different quantity, basis, or operating regime).\nD) 36 kN/m: Selecting “36 kN/m” mixes up a neighbouring syllabus result with the stem’s actual ask. Under the given data/conditions the governing check yields “48 kN/m”, not “36 kN/m” (different quantity, basis, or operating regime).\n\nWHAT TO REMEMBER (concrete facts — not topic headings):\n• Decide from the stem’s asked quantity only — here the keyed result is “48 kN/m”.\n• For earth pressure+numerical: write the governing formula/definition before looking at options; then match units and basis.\n• If two options look close, check which assumption/sign/share the stem actually forces.\n\nALSO ASKED / HIGH CHANCE (concrete alternate angles):\n• Same earth pressure+numerical with one changed datum (length, load, or code factor) — recompute rather than scaling the keyed answer blindly.\n• Examiner twin: name the classic wrong basis for earth pressure+numerical (gross vs net, peak vs RMS, service vs factored, etc.).",
    "source": "CIVIL_FLT01_AUDITQ_APPROVED_v1",
    "origin": "Inspired-APPSC"
  },
  {
